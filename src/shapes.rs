...
impl Corner {
    pub const TOP_LEFT: Corner = Corner {
        x: Pos::Left,
        y: Pos::Left,
    };
    pub const TOP: Corner = Corner {
        x: Pos::Center,
        y: Pos::Left,
    };
    pub const TOP_RIGHT: Corner = Corner {
        x: Pos::Right,
        y: Pos::Left,
    };
    pub const LEFT: Corner = Corner {
        x: Pos::Left,
        y: Pos::Center,
    };
    pub const CENTER: Corner = Corner {
        x: Pos::Center,
        y: Pos::Center,
    };
    pub const RIGHT: Corner = Corner {
        x: Pos::Right,
        y: Pos::Center,
    };
    pub const BOTTOM_LEFT: Corner = Corner {
        x: Pos::Left,
        y: Pos::Right,
    };
    pub const BOTOOM: Corner = Corner {
        x: Pos::Center,
        y: Pos::Right,
    };
    pub const BOTTOM_RIGHT: Corner = Corner {
        x: Pos::Right,
        y: Pos::Right,
    };
}
...
impl Rectangle {
    ...
    pub fn point_inside(&self, p: Point) -> bool {
        self.pos_x(Pos::Left) <= p.x
            && p.x <= self.pos_x(Pos::Right)
            && self.pos_y(Pos::Left) <= p.y
            && p.y <= self.pos_y(Pos::Right)
    }
}
...
impl PositionedRectangle {
    ...
    pub fn rectangle_overlaps(&self, r: PositionedRectangle) -> bool {
        !(self.pos_x(Pos::Right) <= r.pos_x(Pos::Left)
            || r.pos_x(Pos::Right) <= self.pos_x(Pos::Left)
            || self.pos_y(Pos::Right) <= r.pos_y(Pos::Left)
            || r.pos_y(Pos::Right) <= self.pos_y(Pos::Left))
    }
}
